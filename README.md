...
xcodebuild -project RedPill.xcodeproj build

##To Install
Just navigate to the RedPill/build/Release

Double click on the RedPill.saver file.  This will add it to the screen savers on your Mac
